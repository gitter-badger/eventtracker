...
window.startApp          = require('eventtracker/tests/helpers/start_app')['default'];
window.isolatedContainer = require('eventtracker/tests/helpers/isolated_container')['default'];
